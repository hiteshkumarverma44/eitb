...
class __TwigTemplate_c9b46fa59ebb8f821e7db8fd07b751d6 extends Template
{
    private $source;
    private $macros = [];
...
";
        // line 30
        $context["classes"] = ["views-view-grid", ("views-view-grid--" . $this->sandbox->ensureToStringAllowed(twig_get_attribute($this->env, $this->source,         // line 32
...
";
        ...
        // line 39
        echo "<div";
        echo $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed(twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, ($context["attributes"] ?? null), "addClass", [($context["classes"] ?? null)], "method", false, false, true, 39), "setAttribute", ["style", ("--views-grid--column-count: " . $this->sandbox->ensureToStringAllowed(twig_get_attribute($this->env, $this->source, ($context["options"] ?? null), "columns", [], "any", false, false, true, 39), 39, $this->source))], "method", false, false, true, 39), 39, $this->source), "html", null, true);
        echo ">
  ";
        // line 40
...
";
    ...
    {
        return new Source("", "core/themes/olivero/templates/views/views-view-grid.html.twig", "K:\\laragon\\www\\hitesh_EITB\\web\\core\\themes\\olivero\\templates\\views\\views-view-grid.html.twig");
    }
